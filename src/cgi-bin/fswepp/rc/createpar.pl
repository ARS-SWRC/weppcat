...
$user_ID = $user_ID . '_';	# DEH 03/05/2001
...
#output file currently ip address of user placed in the directory passed in - ELA 5/1/2008
$outfile = "$workingdir" . $user_ID . '.PAR';
...
$fmt_sdp = ' S DEV P%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f%6.2f';
...
print   NEWPAR  "\n";
printf  NEWPAR  $fmt_sdp, $sd_p[0],$sd_p[1],$sd_p[2],$sd_p[3],$sd_p[4],$sd_p[5],$sd_p[6],$sd_p[7],$sd_p[8],$sd_p[9],$sd_p[10],$sd_p[11];
print   NEWPAR  "\n";
...
if ($platform eq 'pc') {
  exec "perl ../rc/showpersonal.pl -download $units $me"}
else {
  exec "../rc/showpersonal.pl -download -u$units $me"
}
