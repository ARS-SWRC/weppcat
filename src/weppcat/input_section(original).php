...
<!--  WEPP Internet model interface: Input section
  ...
  --  by Daniel Esselbrugge & later by Eric Anson
...
{ 
	...
	modCliURL = "/cgi-bin/fswepp/rc/modpar.pl?";
	...
	modCliURL = modCliURL + "&CL=" + document.RockClime.state.value + "/" + document.RockClime.state.value.toUpperCase() + document.RockClime.station.value;
